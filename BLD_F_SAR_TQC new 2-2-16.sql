        ...
        from (
            ...
            left join (
                ...
                from
                    ...
                    inner join k12intel_dw.dtbl_students_evolved dstue
                        on fmrk.student_evolve_key = dstue.student_evolve_key
                    ...
                    inner join k12intel_keymap.km_stu_marks_fin_ic km 
                        on fmrk.student_marks_key = km.student_marks_key
                 where 1=1
